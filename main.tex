...
\end{figure}
\begin{lstlisting}
wget https://github.com/kamujuaakash/EE3900/blob/main/codes/5.3.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/kamujuaakash/EE3900/blob/main/codes/5.5.py
\end{lstlisting}
%
...
%
\begin{lstlisting}
wget https://github.com/kamujuaakash/EE3900/blob/main/codes/hndef.py
\end{lstlisting}
Computing,\\
$h(0)=1$\\
$h(1)=-\frac{1}{2}h(0)$\\
...
%
\begin{lstlisting}
wget https://github.com/kamujuaakash/EE3900/blob/main/codes/ynconv.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
