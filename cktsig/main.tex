...
\begin{lstlisting}
	wget https://github.com/Naresh13/EE3900/tree/main/cktsig/codes/2.8.cir
\end{lstlisting}
And is plotted using the below code.
\begin{lstlisting}
	wget https://github.com/Naresh13/EE3900/tree/main/cktsig/codes/2.8.py
\end{lstlisting}
...
\begin{lstlisting}
	wget https://github.com/Naresh13/EE3900/tree/main/cktsig/codes/4.2.py
\end{lstlisting}
...
%\end{align}
	...
	\begin{lstlisting}
	wget https://github.com/Naresh13/EE3900/tree/main/cktsig/codes/4.3.py
	\end{lstlisting}
	\begin{figure}[!ht]
		\centering
